    ...
    <div className="flex flex-col w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-space-xl items-center">
            ...
            <div className="flex flex-col items-start order-2 lg:order-1">
              ...
              <div className="flex flex-wrap gap-space-sm">
                <Link
                  href="/book"
                  className="inline-flex items-center gap-space-xs px-space-xl py-[14px] rounded-full bg-primary-container text-on-primary-container text-label-lg font-display font-bold shadow-glow-cyan hover:opacity-95 transition-all group"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-space-xs px-space-xl py-[14px] rounded-full bg-tertiary text-on-tertiary text-label-lg font-display font-semibold hover:opacity-90 transition-all"
                >
        ...
        <div className="max-w-7xl mx-auto px-margin">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-space-md">
            {[
              ...
              <div key={mode.title} className="bg-surface-container-lowest rounded-lg p-space-lg shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-space-sm">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center ${mode.color}`}>
                ...
                <a
                  ...
                  className={`mt-space-md flex items-center justify-center gap-1.5 py-space-sm rounded-full text-label-md font-display font-bold transition-all ${mode.color} hover:opacity-90`}
                >
                  {mode.cta}
        ...
        <div className="max-w-7xl mx-auto px-margin">
          ...
          <div className="flex gap-space-md overflow-x-auto pb-space-sm no-scrollbar md:grid md:grid-cols-2 lg:grid-cols-4">
            {doctor.clinics.map((clinic) => (
              <div
                key={clinic.id}
                className="shrink-0 w-[280px] md:w-auto bg-surface-container-lowest rounded-lg p-space-md shadow-card flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-space-sm">
                    <span className={`text-label-sm font-display font-bold px-space-sm py-0.5 rounded-full ${
                    ...
                    <span className="text-title-md font-display font-extrabold text-on-surface">
                ...
                <Link
                  href="/book"
                  className="mt-space-md w-full py-2.5 rounded-full bg-primary text-on-primary text-label-md font-display font-bold text-center flex items-center justify-center gap-1.5 hover:opacity-90 transition-all"
                >
      ...
      <section className="py-space-xl bg-inverse-surface text-inverse-on-surface" aria-label="Patient testimonials">
        <div className="max-w-7xl mx-auto px-margin">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-space-md">
            {[
              ...
              <div key={r.name} className="bg-surface-container-lowest/10 backdrop-blur-sm rounded-lg p-space-lg">
                ...
                <p className="text-body-md text-secondary-fixed-dim leading-relaxed italic">{r.quote}</p>
              </div>
            ))}
          </div>
          <div className="text-center mt-space-xl">
            <Link
              href="/reviews"
              className="inline-flex items-center gap-space-xs px-space-xl py-[14px] rounded-full bg-primary-container text-on-primary-container text-label-lg font-display font-bold hover:opacity-95 transition-all"
            >
      ...
      <section className="py-space-xl bg-surface-container-low" aria-label="Care philosophy">
        <div className="max-w-4xl mx-auto px-margin text-center">
          ...
          <blockquote className="text-headline-md font-display font-bold text-on-surface leading-snug mt-space-sm mb-space-lg">
            {doctor.philosophy}
          </blockquote>
          <div className="flex items-center justify-center gap-space-sm">
            ...
            <span className="inline-flex items-center gap-1 text-label-sm font-display font-bold text-tertiary bg-tertiary-container/20 px-space-sm py-0.5 rounded-full ml-space-sm">
          ...
          <div className="bg-inverse-surface rounded-xl p-space-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-space-md">
                <Link
                  href="/book"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-space-xs px-space-xl py-[14px] rounded-full bg-primary-container text-on-primary-container text-label-lg font-display font-bold shadow-glow-cyan hover:opacity-95 transition-all group"
                >
                  Book Consultation
                  <span className="material-symbols-outlined text-[20px] transition-transform group-hover:translate-x-0.5">arrow_forward</span>
                </Link>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-space-xs px-space-xl py-[14px] rounded-full bg-tertiary text-on-tertiary text-label-lg font-display font-semibold hover:opacity-90 transition-all"
                >
                  <span className="material-symbols-outlined text-[20px]">chat</span>
